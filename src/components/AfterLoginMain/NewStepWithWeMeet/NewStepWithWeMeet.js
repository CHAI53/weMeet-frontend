        ...
        <ul className="new-step-cards">
            ...
            <div className="background-green">
              <div className="new-step-card-flex">
                <div className="new-step-card-content">
                  <h3 className="new-step-card-header">수업 개설하기</h3>
                  <p className="new-step-card-cta">자세히 알아보기</p>
                </div>
              </div>
            </div>
          </li>
          <li className="new-step-card">
            <div className="background-yellow">
              <div className="new-step-card-flex">
                <div className="new-step-card-content">
                  <h3 className="new-step-card-header">새로운 사람 만나기</h3>
                  <p className="new-step-card-cta">자세히 알아보기</p>
                </div>
              </div>
            </div>
          ...
          <li className="new-step-card">
            <div className="background-red">
              <div className="new-step-card-flex">
                <div className="new-step-card-content">
                  <h3 className="new-step-card-header">브랜드 키우기</h3>
                  <p className="new-step-card-cta">자세히 알아보기</p>
                </div>
              </div>
            </div>
          ...
          <li className="new-step-card">
            <div className="background-blue">
              <div className="new-step-card-flex">
                <div className="new-step-card-content">
                  <h3 className="new-step-card-header">외국어 회화 연습하기</h3>
                  <p className="new-step-card-cta">자세히 알아보기</p>
                </div>
              </div>
            </div>
