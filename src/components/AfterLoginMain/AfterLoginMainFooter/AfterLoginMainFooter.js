      ...
      <div className="after-login-main-footer-wrapper">
        <div className="after-login-main-footer-feed">
          <div className="after-login-main-footer-feed-top">
            <span className="after-login-main-footer-feed-top-newgroup">
              새 그룹 시작하기
            </span>
            <span className="after-login-main-footer-feed-top-login">
              로그아웃
            </span>
          </div>
          ...
          <div className="after-login-main-footer-feed-follow">
            ...
            <div className="icon">
              ...
              <a href="https://twitter.com/meetup">
                <img src={require("../../../Images/twitter.png")} alt=""></img>
              </a>
            </div>
          </div>
          <div className="after-login-main-footer-feed-bottom-wrapper">
            <div className="after-login-main-footer-feed-helper">
              <span className="after-login-main-footer-helper-first">
                © 2019 We:Meet
              </span>{" "}
              We:Meet은 Graceful_rain Companies Inc.의 전액출자 자회사입니다.
            </div>
