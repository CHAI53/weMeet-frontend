  ...
  example: [
    {
      ...
      desc:
        "Friday pre-drink Pub Party and Club in Gangnam! 강남 인터내셔널 펍파티와 클럽! 불금",
      location: "서울, 한국(대한민국)",
      people: "15"
    },
    {
    ...
    },
    {
      date: "2019년 11월 6일 수요일",
      name:
        "Gangnam Language Exchange? Better: 회화 영어 + Public Speaking + Joy = 😍Amazing!",
